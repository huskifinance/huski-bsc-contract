...
describe('PancakeswapV2CakeMaxiWithdrawMinimizeTrading', () => {
  ...
  /// Strategy instance(s)
  let strat: PancakeswapV2CakeMaxiWithdrawMinimizeTrading;
  ...
  let stratAsAlice: PancakeswapV2CakeMaxiWithdrawMinimizeTrading;
  let stratAsBob: PancakeswapV2CakeMaxiWithdrawMinimizeTrading;
  ...
  beforeEach(async () => {
    ...
    strat = await upgrades.deployProxy(PancakeswapV2CakeMaxiWithdrawMinimizeTrading, 
      [routerV2.address, wNativeRelayer.address], { unsafeAllow: ['delegatecall'] }) as PancakeswapV2CakeMaxiWithdrawMinimizeTrading;
    ...
    stratAsAlice = PancakeswapV2CakeMaxiWithdrawMinimizeTrading__factory.connect(strat.address, alice);
    stratAsBob = PancakeswapV2CakeMaxiWithdrawMinimizeTrading__factory.connect(strat.address, bob);
  ...
  context('When the base token is a wrap native', async () => {
    context('When contract get farmingAmount amount < minFarmingAmount', async () => {
        it('should revert', async () => {
          ...
          )).to.be.revertedWith('PancakeswapV2CakeMaxiWithdrawMinimizeTrading::execute: insufficient farmingToken amount received');
        });
      })
    ...
    context("When caller worker hasn't been whitelisted", async () => {
      it('should revert as bad worker', async () => {
        ...
        )).to.be.revertedWith('PancakeswapV2CakeMaxiWithdrawMinimizeTrading::onlyWhitelistedWorkers: bad worker');
      });
    })
