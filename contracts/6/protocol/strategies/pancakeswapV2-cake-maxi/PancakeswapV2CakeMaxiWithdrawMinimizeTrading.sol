...
contract PancakeswapV2CakeMaxiWithdrawMinimizeTrading is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  modifier onlyWhitelistedWorkers() {
    require(okWorkers[msg.sender], "PancakeswapV2CakeMaxiWithdrawMinimizeTrading::onlyWhitelistedWorkers: bad worker");
    _;
  }
    ...
    nonReentrant
  {
    ...
    require(remainingFarmingToken >= minFarmingTokenAmount, "PancakeswapV2CakeMaxiWithdrawMinimizeTrading::execute: insufficient farmingToken amount received");
