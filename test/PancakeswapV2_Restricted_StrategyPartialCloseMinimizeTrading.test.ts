...
describe("PancakeswapV2PartialCloseMinimizeTrading", () => {
  ...
  /// Strategy instance(s)
  let strat: PancakeswapV2PartialCloseMinimizeTrading;
  ...
  let stratAsAlice: PancakeswapV2PartialCloseMinimizeTrading;
  let stratAsBob: PancakeswapV2PartialCloseMinimizeTrading;
  ...
  async function fixture() {
    ...
    strat = (await upgrades.deployProxy(PancakeswapV2PartialCloseMinimizeTrading, [
      routerV2.address,
      wbnb.address,
      wNativeRelayer.address,
    ], { unsafeAllow: ['delegatecall'] })) as PancakeswapV2PartialCloseMinimizeTrading;
    ...
    stratAsAlice = PancakeswapV2PartialCloseMinimizeTrading__factory.connect(strat.address, alice);
    stratAsBob = PancakeswapV2PartialCloseMinimizeTrading__factory.connect(strat.address, bob);
    ...
    context("when maxLpTokenToLiquidate > LP from worker", async () => {
      it("should use all LP", async () => {
        ...
        await expect(
          ...
          .to.emit(strat, "PartialCloseMinimizeTradingEvent")
          .withArgs(
            baseToken.address,
            farmingToken.address,
