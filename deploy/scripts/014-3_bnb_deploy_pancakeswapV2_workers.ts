...
*/
  ...
  const WORKERS = [
    {
      ...
      BASE_TOKEN_ADDR: config.Tokens.WBNB,
  ...
  for (let i = 12; i < WORKERS.length; i++) {
    console.log("===================================================================================")
    ...
    // const pancakeswapV2Worker = PancakeswapV2Worker__factory.connect('0xA82A626a3008dB2c641d093dC4cDCaefd4bF15Ee', (await ethers.getSigners())[0])
...
export default func;
func.tags = ['PancakeswapV2WorkersBNB'];