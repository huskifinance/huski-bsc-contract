...
contract PancakeswapV2CakeMaxiAddBaseTokenOnly is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  modifier onlyWhitelistedWorkers() {
    require(okWorkers[msg.sender], "PancakeswapV2CakeMaxiAddBaseTokenOnly::onlyWhitelistedWorkers: bad worker");
    _;
  }
    ...
    nonReentrant
  {
    ...
    require(farmingToken.myBalance() >= minFarmingTokenAmount, "PancakeswapV2CakeMaxiAddBaseTokenOnly::execute: insufficient farmingToken amount received");
