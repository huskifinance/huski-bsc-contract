...
*/
  ...
  const WORKERS = [
    {
      ...
      BASE_TOKEN_ADDR: config.Tokens.USDT,
  ...
  for (let i = 1; i < WORKERS.length; i++) {
    ...
    // const pancakeswapV2Worker = PancakeswapV2Worker__factory.connect('0x9CF453e5CeECEdB0A8A2799EabD1557cE93364EE', (await ethers.getSigners())[0])
...
export default func;
func.tags = ['PancakeswapV2WorkersUSDT'];