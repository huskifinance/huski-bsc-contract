...
interface IFairLaunchV1 {
  ...
  struct PoolInfo {
    ...
    uint256 accHuskyPerShare;
    uint256 accHuskyPerShareTilBonusEnd;
  }

  // Information query functions
  function huskyPerBlock() external view returns (uint256);
  ...
  // OnlyOwner functions
  function setHuskyPerBlock(uint256 _huskyPerBlock) external;
