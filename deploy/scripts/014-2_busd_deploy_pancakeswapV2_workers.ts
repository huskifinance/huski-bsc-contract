...
*/
  ...
  const WORKERS = [
    ...
    //   BASE_TOKEN_ADDR: config.Tokens.BUSD,
  ...
  for (let i = 5; i < WORKERS.length; i++) {
    console.log("===================================================================================")
    ...
    const pancakeswapV2Worker = await upgrades.deployProxy(
      ...
      WORKERS[i].MASTER_CHEF_ADDR,
      WORKERS[i].PANCAKESWAP_ROUTER_ADDR, 
      WORKERS[i].POOL_ID, 
...
export default func;
func.tags = ['PancakeswapV2WorkersBUSD'];