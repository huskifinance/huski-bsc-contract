...
contract PancakeswapV2CakeMaxiAddBaseWithFarm is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  modifier onlyWhitelistedWorkers() {
    require(okWorkers[msg.sender], "PancakeswapV2CakeMaxiAddBaseWithFarm::onlyWhitelistedWorkers: bad worker");
    _;
  }
    ...
    nonReentrant
  {
    ...
    require(farmingToken.myBalance().sub(inputFarmingTokenAmount) >= minFarmingTokenAmount, "PancakeswapV2CakeMaxiAddBaseWithFarm::execute: insufficient farmingToken amount received");
