...
contract PancakeswapV2AddBaseTokenOnly is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  modifier onlyWhitelistedWorkers() {
    require(okWorkers[msg.sender], "PancakeswapV2AddBaseTokenOnly::onlyWhitelistedWorkers: bad worker");
    _;
  }
    ...
    nonReentrant
  {
    ...
    // 19975^2 = 399000625
    // 9975*2 = 19950
    uint256 aIn = HuskyMath.sqrt(rIn.mul(balance.mul(399000000).add(rIn.mul(399000625)))).sub(rIn.mul(19975)) / 19950;
    ...
    require(moreLPAmount >= minLPAmount, "PancakeswapV2AddBaseTokenOnly::execute: insufficient LP tokens received");
    require(lpToken.transfer(msg.sender, lpToken.balanceOf(address(this))), "PancakeswapV2AddBaseTokenOnly::execute: failed to transfer LP token to msg.sender");
