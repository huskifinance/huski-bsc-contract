...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  if (newImpl === '') {
    ...
    const NewPancakeswapV2Worker = (await ethers.getContractFactory('PancakeswapV2Worker')) as PancakeswapV2Worker__factory;
    const preparedNewWorker = await upgrades.prepareUpgrade(TO_BE_UPGRADE_WORKERS[0], NewPancakeswapV2Worker)
